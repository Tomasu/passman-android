...
class CircularAnimatedDrawable extends Drawable implements Animatable
{
			...
			= new Property< CircularAnimatedDrawable, Float >( Float.class, "angle" )
	{
		@Override
		public
		Float get ( CircularAnimatedDrawable object )
		{
		...
		@Override
		public
		void set ( CircularAnimatedDrawable object, Float value )
		{
	...
	public
	void setCurrentGlobalAngle ( float currentGlobalAngle )
	{
